...
@section('content')
    <div ng-controller="UsersController" ng-init="load('{{ $id }}')">
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 text-right">
                                <button ng-click="update()" class="btn btn-success btn-fill" ng-disabled="userForm.$invalid || !user.roles || user.roles.length === 0">{{ trans('app.save') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
