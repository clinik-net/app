            ...
            <div class="col-xs-12">
                <div class="card">
                    ...
                    <div class="content">
                        ...
                        <h4>{{ trans('app.admin') }}</h4>
                        <div class="row">
                            <form name="adminForm">
                                <div class="form-group  col-md-6 col-xs-12">
                                    <label>{{ trans('app.name') }}</label>
                                    <input type="text" name="admin_name" ng-model="company.admin.name" class="form-control" />
                                </div>
                                <div class="form-group  col-md-6 col-xs-12">
                                    <label>{{ trans('app.email') }}</label>
                                    <input type="text" name="admin_email" ng-model="company.admin.email" class="form-control" />
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 text-right">
                                <button ng-click="create()" class="btn btn-success btn-fill" ng-disabled="companyForm.$invalid || adminForm.$invalid || addressForm.$invalid">{{ trans('app.save') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
