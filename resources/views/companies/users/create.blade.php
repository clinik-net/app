...
@section('content')
    <div ng-controller="CompaniesController" ng-init="initUser({companyId: '{{ $id }}'})">
        <h3 class="col-xs-12">
            {{ trans('user.create') }}
        </h3>
        <div class="row">
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 text-right">
                                <button ng-click="createUser()" class="btn btn-success btn-fill" ng-disabled="userForm.$invalid || !user.roles || user.roles.length === 0">{{ trans('app.save') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
